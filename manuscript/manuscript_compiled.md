...
### Collaboration and partnerships with other actors
...
We asked respondents to comment on their perceptions of US-led anti-TIP advocacy, both with local and national governments and with the general public (see [@fig:activities]). Organizations noted that the United States has been particularly effective in its work with local governments, using its TIP reports to pressure governments to implement TIP reforms and then assisting with the implementation of new anti-TIP legislation. NGOs also described how the US sponsors dozens of programs aimed at improving public awareness of TIP issues, including workshops and conferences where experts train activists, government officials, and the general public. Additionally, NGOs reported a variety of grants and other support for organizations that publicly advocate and provide legal and social services for TIP victims.
...
From the perspective of anti-TIP NGOs, the State Department's annual TIP report is perhaps the US government's most potent tool for confronting or working with foreign governments. More than 40% of respondents indicated that the United States has increased government attention to TIP issues in the countries they work in, and the majority of these organizations specifically mentioned the US embassy's use of the TIP report in those countries. Many see the report as the United States' primary means for working directly with foreign governments, noting that the report has been an "extremely important,"^[Response 1475.] "very effective,"^[Response 1442.] and "quite useful"^[Response 1390.] tool that allows the US government to "[suggest] changes to anti-trafficking laws and policy, [raise] awareness about trafficking, and [increase] [foreign government] attention to trafficking."^[Response 1158.] NGOs also describe US officials using the report to threaten, pressure, and embarrass offending governments,^[Responses 1017, 1158, and 1259.] and state that the report "force[s] an official response from the government … every year when it is released."^[Response 1387.] In several cases, NGOs report that embassies invite high-ranking government officials and party leaders for formal discussions about the report's recommendations and future steps.^[Responses 1104, 1259, and 1360.]
...
2 DVs - positivity (Q3.25) and importance (Q3.19) (though positivity is censored by importance)

Cooptation

* [X] Tier rating (average) or improvement in Cho score?
* [X] Whether an NGO has received US funding (or where the COUNTRY has received more TIP grants?)
	No. Receiving funding doesn't influence relationship (kind of (p = 0.15); what happens if I exclude don't know? Would have to exclude it when checking other variables too.
	Has the country received more TIP grants?
* [X] Whether an NGO has interacted with the US
	No. There's no relationship (`chisq.test(us.table)`)
So, opinions are not driven by cooptation - NGOs are not being bought out

* [ ] Whether a country is rich or poor (or some other quality)
* [ ] Democracy?
* [ ] Whether an NGO focuses on certain types of work?
* [X] In which countries does the US seem to have had more collaboration with NGOs?
