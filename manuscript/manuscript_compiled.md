...
An important caveat: these statistical findings are solely descriptive and serve to help interpret many of the trends we discovered in the anti-TIP NGO sector. We use inferential statistics only to measure differences in group means, not to test *a priori* hypotheses selected to prove or disprove any theories. 
